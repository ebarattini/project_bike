 ...
 "cells": [
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Int64Index: 489727 entries, 0 to 538378\n",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      " #   Column             Non-Null Count  Dtype  \n",
      "---  ------             --------------  -----  \n",
      " 0   latitude           51440 non-null  float64\n",
      " 1   longitude          51440 non-null  float64\n",
      " 2   temp               51440 non-null  float64\n",
      " 3   feelslike          51440 non-null  float64\n",
      " 4   humidity           51440 non-null  float64\n",
      " 5   precip             51440 non-null  float64\n",
      " 6   snow               51440 non-null  float64\n",
      " 7   snowdepth          51440 non-null  float64\n",
      " 8   windgust           51384 non-null  float64\n",
      " 9   windspeed          51440 non-null  float64\n",
      " 10  cloudcover         51440 non-null  float64\n",
      " 11  visibility         51440 non-null  float64\n",
      " 12  is_school_holiday  51440 non-null  int64  \n",
      " 13  is_strike          51440 non-null  int64  \n",
      " 14  full_lockdown      51440 non-null  int64  \n",
      " 15  partial_lockdown   51440 non-null  int64  \n",
      " 16  school_closures    51440 non-null  int64  \n",
      " 17  business_closures  51440 non-null  int64  \n",
      " 18  hour               51440 non-null  int64  \n",
      " 19  year               51440 non-null  int64  \n",
      " 20  month              51440 non-null  int64  \n",
      " 21  day                51440 non-null  int64  \n",
      " 22  weekday            51440 non-null  int64  \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "])\n",
    "\n",
    "# Assuming X_xgb and y_xgb are your training data\n",
    "# Step 2: Fitting the Model\n",
    "pipeline.fit(X_xgb, y_xgb)\n",
    "\n",
    "# Assuming X_test is your test data for submission\n",
